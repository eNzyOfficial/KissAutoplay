...
(function () {
    ...
    Store.prototype.set = function (name, value) {
        if (value === undefined) {
            ...
            localStorage.setItem("kiss." + this.name + "." + name, value);

            let obj = {};
            obj['kiss.' + this.name + '.' + name] = value;
    ...
    Store.prototype.remove = function (name) {
        localStorage.removeItem("kiss." + this.name + "." + name);
        chrome.storage.sync.remove("kiss." + this.name + "." + name);
        return this;
    };
